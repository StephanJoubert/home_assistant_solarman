    ...
    STEP_USER_DATA_SCHEMA = vol.Schema(
        {
            ...
            vol.Optional(
                CONF_INVERTER_MB_SLAVEID, default=data.get(CONF_INVERTER_MB_SLAVEID)
            ): int,
...
class ConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(
        ...
        try:
            ...
            _LOGGER.debug(
                f"config_flow.py:ConfigFlow.async_step_user: validation passed: {user_input}"
            )
        ...
        _LOGGER.debug(
            f"config_flow.py:ConfigFlow.async_step_user: validation failed: {user_input}"
        )
